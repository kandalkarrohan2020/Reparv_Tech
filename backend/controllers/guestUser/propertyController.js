...
export const getAll = (req, res) => {
  const sql = `SELECT properties.*, builders.company_name FROM properties 
               INNER JOIN builders ON properties.builderid = builders.builderid WHERE properties.guestUserId = ? 
  ...
  db.query(
    ...
    (err, result) => {
      ...
      INSERT INTO properties (
        guestUserId, builderid, propertyCategory, propertyApprovedBy, propertyName, address, state, city, pincode, location,
