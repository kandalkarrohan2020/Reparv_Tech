...
export default function IndivisualHouse() {
  ...
  const fetchLocationByCity = async () => {
    try {
      const response = await fetch(
        URI + "/territory-partner/indivisualhouse/location/" + city,
        {
          method: "GET",
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/indivisualhouse", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchAllCity = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/indivisualhouse/allcity", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocation = async () => {
    try {
      const response = await fetch(
        URI + "/territory-partner/indivisualhouse/alllocation",
        {
          method: "GET",
          credentials: "include", // ✅ Ensures cookies are sent
          headers: {
  ...
  const addLike = async (id) => {
    try {
      const response = await fetch(URI + "/territory-partner/indivisualhouse/like/" + id, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
        ...
        <div className="flex flex-wrap gap-2 sm:gap-5 bg-transparent">
          <div className="flex">
            <select
              ...
              className="w-full h-10 px-2  appearance-none border border-[#00000033] rounded-md"
            >
