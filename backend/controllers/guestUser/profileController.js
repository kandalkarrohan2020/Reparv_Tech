...
export const editProfile = (req, res) => {
  ...
  db.query("SELECT userimage FROM guestUsers WHERE id = ?", [userId], (err, result) => {
    if (err) {
    ...
    let updateSql = `UPDATE guestUsers SET fullname = ?, username = ?, contact = ?, email = ?, userimage = ?, updated_at = ? WHERE id = ?`;
    const updateValues = [
      fullname,
      username,
      contact,
