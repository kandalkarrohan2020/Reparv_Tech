...
export default function Rental() {
  ...
  const fetchLocationByCity = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/rental/location/" + city, {
        method: "GET",
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/rental", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchAllCity = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/rental/allcity", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocation = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/rental/alllocation", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const addLike = async (id) => {
    try {
      const response = await fetch(URI + "/territory-partner/rental/like/" + id, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
