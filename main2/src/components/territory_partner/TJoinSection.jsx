  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:4000/admin/territorypartner/add`,
        {
          method: "POST",
          credentials: "include",
          body: formData,
  ...
  return (
    <>
      <div
        ...
        className=" absolute  flex flex-col w-full item-center p-2 lg:items-center gap-[32px]  h-[867px]  lg:h-[1027px]  lg:top-[3453px] top-[4300px] md:top-[5450px]"
      >
        {/* Form title */}
        ...
        <div className="flex   sm:mx-auto   flex-col lg:flex-row items-start   w-full   p-2 lg:p-0 w-full lg:w-[996px] md:h-[900px]  lg:h-[880px]">
          {/* banner for desktop screen */}
          <div className=" hidden lg:flex flex-col items-start p-8 gap-8 w-[293px] h-[880px] bg-[#065B9C] rounded-lg">
          ...
          <div className="flex mx-auto   flex-col  lg:mx-0 items-start  mt-[10px] lg:mt-0 p-4 gap-6 md:w-[600px]  lg:w-[703px]  lg:h-[880px] bg-white border-l border-t border-b border-[#e5e5e5] shadow-lg rounded-r-lg">
