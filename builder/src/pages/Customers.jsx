...
const Customers = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${URI}/builder/customers`, {
        method: "GET",
  ...
  const viewCustomer = async (id) => {
    try {
      const response = await fetch(`${URI}/builder/customers/${id}`, {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchPaymentData = async (id, customer) => {
    try {
      const response = await fetch(`${URI}/builder/customers/payment/get/${id}`, {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
