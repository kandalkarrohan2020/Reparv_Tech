...
const EMICalculator = ({ totalAmount }) => {
  ...
  const downPaymentPercentage = totalAmount === 0 ? 0 : (downPayment / totalAmount) * 100;
  ...
  useEffect(() => {
    ...
    const emiCalc =
      (principal * monthlyInterest * Math.pow(1 + monthlyInterest, numberOfMonths)) /
      ...
      <div className="w-full flex flex-col gap-4 ">
        ...
        <div className="w-full flex flex-col gap-2">
          <div className="w-full flex items-center justify-between">
            ...
            <div className="px-6 py-2 bg-white border border-[#00000033] rounded-md text-sm font-medium ">
              <FormatPrice price={downPayment} />
            </div>
          </div>
        ...
        <div className="w-full flex flex-col gap-2">
          <div className="w-full flex items-center justify-between">
            ...
            <div className="px-6 py-2 bag-white border border-[#00000033] rounded-md text-sm font-medium ">
