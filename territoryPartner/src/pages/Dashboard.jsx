...
function Dashboard() {
  ...
  const fetchCountData = async () => {
    try {
      const response = await fetch(`${URI}/territory-partner/dashboard/count`, {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/dashboard/enquiries", {
        method: "GET",
