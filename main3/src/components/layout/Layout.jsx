...
function Layout() {
  ...
  //hides footer paths
  const isReparvInPartnerPage =
    location.pathname === "/salespartner" ||
    location.pathname === "/territorypartner" ||
    location.pathname === "/onboardingpartner" ||
    location.pathname === "/projectpartner";
  ...
  return (
    <div className="layout w-full flex flex-col bg-white overflow-hidden ">
      ...
      <div
        className={`w-full ${
          isReparvInPartnerPage ? "pt-0 sm:pt-0" : "pt-15 sm:pt-22"
        } bg-white`}
      >
        <Outlet />
      </div>

      {!isReparvInPartnerPage && (
        <>
          {/* footer */}
