...
export default function Resale() {
  ...
  const fetchLocationByCity = async () => {
    try {
      const response = await fetch(URI + "/frontend/resale/location/" + city, {
        method: "GET",
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(URI + "/frontend/resale", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchAllCity = async () => {
    try {
      const response = await fetch(URI + "/frontend/resale/allcity", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocation = async () => {
    try {
      const response = await fetch(URI + "/frontend/resale/alllocation", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const addLike = async (id) => {
    try {
      const response = await fetch(URI + "/frontend/resale/like/" + id, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
