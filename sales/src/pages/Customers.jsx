...
const Customers = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${URI}/sales/customers`, {
        method: "GET",
  ...
  const viewCustomer = async (id) => {
    try {
      const response = await fetch(`${URI}/sales/customers/${id}`, {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchPaymentData = async (id, customer) => {
    try {
      const response = await fetch(`${URI}/sales/customers/payment/get/${id}`, {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const addCustomerPayment = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${URI}/sales/customers/payment/add/${enquirerId}`,
        {
          method: "POST",
          credentials: "include",
          body: formData,
