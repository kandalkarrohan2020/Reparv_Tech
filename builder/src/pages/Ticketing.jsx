...
const Ticketing = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await fetch(URI + "/sales/tickets", {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  const edit = async (id) => {
    try {
      const response = await fetch(`${URI}/sales/tickets/${id}`, {
        method: "GET",
  ...
  const reOpen = async (id) => {
    ...
    try {
      const response = await fetch(
        URI + `/sales/tickets/re-open/ticket/${id}`,
        {
          method: "PUT",
          credentials: "include", // Ensures cookies are sent
          headers: {
  ...
  const del = async (id) => {
    ...
    try {
      const response = await fetch(URI + `/sales/tickets/delete/${id}`, {
        method: "DELETE",
        credentials: "include",
      });
