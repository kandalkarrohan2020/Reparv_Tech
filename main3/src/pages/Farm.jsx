...
export default function Farm() {
  ...
  const fetchLocationByCity = async () => {
    try {
      const response = await fetch(URI + "/frontend/farm/location/" + city, {
        method: "GET",
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(URI + "/frontend/farm", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchAllCity = async () => {
    try {
      const response = await fetch(URI + "/frontend/farm/allcity", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocation = async () => {
    try {
      const response = await fetch(URI + "/frontend/farm/alllocation", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const addLike = async (id) => {
    try {
      const response = await fetch(URI + "/frontend/farm/like/" + id, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
