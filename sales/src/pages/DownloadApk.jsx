  ...
  return (
    <div className="max-h-[100vh] mt-5 bg-gradient-to-b from-green-50 via-white to-green-50 flex flex-col items-center justify-center px-6 py-16 rounded-2xl">
      ...
      <p className="text-gray-700 text-lg md:text-xl text-center max-w-2xl mb-8">
        ...
        Manage leads, close deals, and grow your earnings — all in one app!
      </p>
      ...
      <div className="relative">
        <img
          src={playStore}
          onClick={()=>{
            window.open("https://play.google.com/store/apps/details?id=com.reparvnewsalesapp","_blank")
          }}
      ...
      {/* Tagline */}
      <p className="mt-12 text-gray-600 text-base text-center">
        “Sell Smarter. Earn Faster. Partner with{" "}
        <span className="font-semibold text-[#00b501]">Reparv</span>.”
      </p>
