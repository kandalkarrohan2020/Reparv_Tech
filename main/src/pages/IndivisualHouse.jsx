...
export default function IndivisualHouse() {
  ...
  const fetchLocationByCity = async () => {
    try {
      const response = await fetch(
        URI + "/frontend/indivisualhouse/location/" + city,
        {
          method: "GET",
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(URI + "/frontend/indivisualhouse", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchAllCity = async () => {
    try {
      const response = await fetch(URI + "/frontend/indivisualhouse/allcity", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocation = async () => {
    try {
      const response = await fetch(
        URI + "/frontend/indivisualhouse/alllocation",
        {
          method: "GET",
          credentials: "include", // ✅ Ensures cookies are sent
          headers: {
  ...
  const addLike = async (id) => {
    try {
      const response = await fetch(URI + "/frontend/indivisualhouse/like/" + id, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
