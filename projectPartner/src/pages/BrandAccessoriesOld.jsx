...
const BrandAccessories = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <div
          ...
          className="orderButton z-10 px-2 lg:px-4 py-[6px] cursor-pointer flex items-center justify-center gap-2 border rounded-md bg-[#EAFBF1] text-green-600 font-semibold text-sm leading-5 active:scale-[0.98]"
        >
          {" "}
          <p>{"Buy"}</p>
    ...
    {
      name: "Available",
      selector: (row) => <p>{row.productQuantity} Units</p>,
      minWidth: "150px",
    },
  ];
          ...
          <div className="grid gap-2 lg:gap-3 grid-cols-1 lg:grid-cols-2">
            ...
            <div className={`w-full `}>
              ...
              <input
                ...
                disabled
                className="w-full mt-[8px] mb-1 text-[16px] font-medium p-3 border border-[#00000033] rounded-[4px] focus:outline-none focus:ring-2 focus:ring-blue-500"
                value={product?.productQuantity + " Units"}
                readOnly
              />
            </div>
          </div>
            ...
            <div className="mt-4 grid gap-2 lg:gap-3 grid-cols-1 lg:grid-cols-2">
              ...
              <div className={`w-full `}>
                ...
                <input
                  ...
                  className="w-full mt-[8px] mb-1 text-[16px] font-medium p-3 border border-[#00000033] rounded-[4px] focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={
                    newOrder?.orderQuantity * product?.productPrice + " Rs"
                  }
                  viewOnly
                />
              </div>
              <div className={`w-full `}>
                ...
                <input
                  ...
                  className="w-full mt-[8px] mb-1 text-[16px] font-medium p-3 border border-[#00000033] rounded-[4px] focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={
                    ((product?.productPrice * product?.gstPercentage) / 100) *
                ...
                <input
                  ...
                  value={
                    (newOrder?.orderQuantity *
                      ...
                      100 +
                    newOrder?.orderQuantity * product?.productPrice +
                    " Rs"
                  }
                  viewOnly
                />
              ...
              orders?.map((order) => (
                <div className="w-full max-w-[500px] p-4 border rounded-xl bg-white shadow-sm space-y-2">
                  ...
                  <div className="flex h-[90px] gap-4 justify-between">
                    ...
                    <div className="p-1">
                      <MdCancel onClick={cancelOrder} className="w-5 h-5 md:w-6 mdLh-6 text-red-600 cursor-pointer"/>
                    </div>
                  </div>
