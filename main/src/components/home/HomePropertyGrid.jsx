...
export default function HomePropertyGrid() {
  ...
  return (
    <div className="flex flex-col items-center justify-center sm:px-4 pb-5 sm:pb-15 md:pb-25">
      {/* Grid Container */}
      <div className={`overflow-hidden w-full max-w-6xl grid ${showMore? "grid-cols-3 md:grid-cols-4 h-auto":"grid-cols-3 h-[230px] sm:h-[340px] md:h-[440px] lg:h-[480px]"} p-4 gap-3 sm:gap-6`} >
        {items.map((item, index) => (
          ...
          >
            {/* Icon */}
            <img src={item.icon} className="w-14 sm:w-20 md:w-23 lg:w-27" alt="" />
            {/* Label */}
