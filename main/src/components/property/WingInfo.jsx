    ...
    <div className="absolute bottom-0 md:top-[150px] max-w-4xl overflow-scroll scrollbar-hide mx-auto w-full md:w-[600px] lg:w-[800px] max-h-[90vh] sm:max-h-[70vh] bg-white rounded-tl-2xl rounded-tr-2xl sm:rounded-xl shadow-xl p-4 pt-6 sm:p-6 space-y-4">
      ...
      <div className="grid gap-2 lg:gap-x-8 lg:gap-y-3 grid-cols-1 lg:grid-cols-2">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <span className="text-black font-semibold">{flat.floor}</span>
        </div>
        <div className="w-full flex items-center justify-between">
          <span className="text-gray-700 font-medium">Flat Number</span>
          <span className="text-black font-semibold">{flat.flatno}</span>
        </div>
        <div className="w-full flex items-center justify-between">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <span className="text-black font-semibold">{flat.facing}</span>
        </div>
        <div className="w-full flex items-center justify-between">
        ...
        <div className="w-full flex items-center justify-between">
          <span className="text-gray-700 font-medium">Super Built-up</span>
          <span className="text-black font-semibold">
            {flat.superbuiltup} sq.ft.
          </span>
        </div>
        <div className="w-full flex items-center justify-between">
        ...
        <div className="w-full flex items-center justify-between">
          <span className="text-gray-700 font-medium">Document Charge</span>
          <span className="text-black font-semibold">
            <FormatPrice price={parseInt(flat.documentcharge)} />
          </span>
        </div>
        <div className="w-full flex items-center justify-between">
          <span className="text-gray-700 font-medium">Water Charge</span>
          <span className="text-black font-semibold">
            <FormatPrice price={parseInt(flat.watercharge)} />
          </span>
        </div>
        <div className="w-full flex items-center justify-between">
          <span className="text-gray-700 font-medium">Clubhouse Charge</span>
          <span className="text-black font-semibold">
            <FormatPrice price={parseInt(flat.clubhousecharge)} />
          </span>
        </div>
        <div className="w-full flex items-center justify-between">
          <span className="text-gray-700 font-medium">Parking Charge</span>
          <span className="text-black font-semibold">
            <FormatPrice price={parseInt(flat.parkingcharge)} />
          </span>
        </div>
        <div className="w-full flex items-center justify-between">
          <span className="text-gray-700 font-medium">Maintenance</span>
          <span className="text-black font-semibold">
            <FormatPrice price={parseInt(flat.maintanance)} />
          </span>
        </div>
        <div className="w-full flex items-center justify-between">
          <span className="text-gray-700 font-medium">Society Deposit</span>
          <span className="text-black font-semibold">
            <FormatPrice price={parseInt(flat.societydeposit)} />
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 pb-4">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <span className="text-black font-semibold">
            <FormatPrice price={parseFloat(flat.totalFlatPrice)} />
          </span>
        </div>
        <div className="lg:col-span-2 border border-gray-700" />
      </div>
