    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/admin" element={<AdminLayout />}>
          <Route path="salespartner" element={<h1>Sales Partner</h1>} />
          <Route path="onboardingpartner" element={<>Onboarding Partner</>} />
          <Route path="territorypartner" element={<></>} />

          <Route path="projectpartner" element={<>Project Partner</>} />
        </Route>
      </Routes>
    </BrowserRouter>
  );
