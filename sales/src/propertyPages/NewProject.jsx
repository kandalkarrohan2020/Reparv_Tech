...
export default function NewProject() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(URI + "/sales/newproject", {
        method: "GET",
  ...
  const fetchAllCity = async () => {
    try {
      const response = await fetch(URI + "/sales/newproject/allcity", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const addLike = async (id) => {
    try {
      const response = await fetch(URI + "/frontend/newproject/like/" + id, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocation = async () => {
    try {
      const response = await fetch(URI + "/sales/newproject/alllocation", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocationByCity = async () => {
    try {
      const response = await fetch(
        URI + "/sales/newproject/location/" + city,
        {
          method: "GET",
          credentials: "include", // ✅ Ensures cookies are sent
          headers: {
