...
const Properties = () => {
  ...
  const columns = [
    ...
    { name: "Property Name", selector: (row) => row.propertyName, sortable: true, minWidth: "150px", },
    {
      name: "Builder",
    ...
    { name: "Type", selector: (row) => row.propertyCategory, sortable: true, minWidth: "150px", },
    { name: "Address", selector: (row) => row.address, sortable: true, minWidth: "200px", },
