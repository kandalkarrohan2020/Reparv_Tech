...
export default function SalesJoinForm() {
  ...
  const validateForm = () => {
    const { fullName, contact, city, email } = currentData;

    if (!fullName || !contact || !city || !email) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        try {
          ...
          // Optional: Navigate to overview or show success message
        ...
        alert(errorRes.message || "Failed to submit form. Please try again.");
      }
    } catch (err) {
  ...
  return (
    <>
      <div
        id="salespartnerjoin"
        className=" absolute w-full mx-auto justify-center top-[5900px] md:top-[6000px] lg:top-[3860px] flex flex-col items-center gap-[32px] p-0"
      >
        <div className="flex flex-col items-center justify-center gap-3 w-full mx-auto h-[120px]">
          ...
          <div className="flex gap-16 justify-center w-full mx-auto mt-20  ">
            {/* Image Section */}
            <div
              className="hidden lg:flex w-[369px] h-[780px] bg-cover bg-center"
            ...
            <div className="flex mx-auto flex-col  lg:mx-0 items-start mt-[10px] lg:mt-0 p-4 lg:p-8 gap-6 w-full sm:w-[600px] md:w-[600px] bg-white  lg:w-[703px]   border-l border-t border-b border-[#e5e5e5] shadow-lg rounded-r-lg">
              ...
              >
                ...
                <div className="flex mt-5 lg:mt-10  lg:ml-0 lg:mt-0 flex-row justify-center items-center gap-12 lg:w-[631px] h-[52px]">
                  <button
                    type="submit"
                    className="flex  lg:ml-0 hover:bg-green-600 justify-center  items-center  px-8 gap-[67px] w-[152] lg:w-[251px] h-[42px] bg-[#2ECD24] rounded-md"
                  >
