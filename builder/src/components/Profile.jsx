...
const Profile = () => {
  ...
  const fetchProfile = async () => {
    try {
      const response = await fetch(`${URI}/builder/profile`, {
        method: "GET",
        credentials: "include",
  ...
  const editProfile = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`${URI}/builder/profile/edit`, {
        method: "PUT",
        credentials: "include",
        body: formData,
      });
  ...
  const changePassword = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${URI}/builder/profile/changepassword`, {
        method: "PUT",
        credentials: "include",
        headers: {
      ...
      alert("Password changed successfully:", data);
