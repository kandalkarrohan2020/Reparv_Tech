...
const Profile = () => {
  ...
  const editProfile = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`${URI}/territory-partner/profile/edit`, {
        method: "PUT",
        credentials: "include",
        body: formData,
      });
  ...
  const changePassword = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${URI}/territory-partner/profile/changepassword`,
        {
          method: "PUT",
          credentials: "include",
          headers: {
  ...
  const changeProjectPartner = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${URI}/territory-partner/profile/project-partner/change/request`, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
