...
const Ticketing = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await fetch(URI + "/promoter/tickets", {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  const fetchAdminData = async () => {
    try {
      const response = await fetch(URI + "/promoter/tickets/admins", {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchDepartmentData = async () => {
    try {
      const response = await fetch(URI + "/promoter/tickets/departments", {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchEmployeeData = async (id) => {
    try {
      const response = await fetch(URI + "/promoter/tickets/employees/" + id, {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const addTicket = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`${URI}/promoter/tickets/${endpoint}`, {
  ...
  const edit = async (id) => {
    try {
      const response = await fetch(`${URI}/promoter/tickets/${id}`, {
        method: "GET",
  ...
  const reOpen = async (id) => {
    ...
    try {
      const response = await fetch(
        URI + `/promoter/tickets/re-open/ticket/${id}`,
        {
          method: "PUT",
          credentials: "include", // Ensures cookies are sent
          headers: {
  ...
  const del = async (id) => {
    ...
    try {
      const response = await fetch(URI + `/promoter/tickets/delete/${id}`, {
        method: "DELETE",
        credentials: "include",
      });
