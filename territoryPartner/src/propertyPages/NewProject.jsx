...
export default function NewProject() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/newproject", {
        method: "GET",
  ...
  const fetchAllCity = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/newproject/allcity", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const addLike = async (id) => {
    try {
      const response = await fetch(URI + "/territory-partner/newproject/like/" + id, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocation = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/newproject/alllocation", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocationByCity = async () => {
    try {
      const response = await fetch(
        URI + "/territory-partner/newproject/location/" + city,
        {
          method: "GET",
          credentials: "include", // ✅ Ensures cookies are sent
          headers: {
