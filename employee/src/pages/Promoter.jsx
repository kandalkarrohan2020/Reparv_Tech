...
const Promoter = () => {
  ...
  const add = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`${URI}/admin/promoter/${endpoint}`, {
  ...
  const edit = async (id) => {
    try {
      const response = await fetch(URI + `/admin/promoter/get/${id}`, {
        method: "GET",
        credentials: "include", //  Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const del = async (id) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(URI + `/admin/promoter/delete/${id}`, {
        method: "DELETE",
        credentials: "include", //  Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const updatePaymentId = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(
        URI + `/admin/promoter/update/paymentid/${partnerId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const fetchFollowUpList = async (id) => {
    try {
      const response = await fetch(
        URI + `/admin/promoter/followup/list/${id}`,
        {
          method: "GET",
          credentials: "include", // Ensures cookies are sent
          headers: {
  ...
  const addFollowUp = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(
        `${URI}/admin/promoter/followup/add/${partnerId}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const assignLogin = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(
        URI + `/admin/promoter/assignlogin/${partnerId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      >
        <div className="w-[330px] sm:w-[600px] overflow-scroll scrollbar-hide md:w-[500px] lg:w-[700px] bg-white py-8 pb-10 px-3 sm:px-6 border border-[#cfcfcf33] rounded-lg">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-[16px] font-semibold">Promoter</h2>
            <IoMdClose
              onClick={() => {
                setShowPartnerForm(false);
              }}
