...
export default function JoinFormSection() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      formData.append("fullname", currentData.fullName);  // make sure fullName is correct
  ...
  return (
    <>
      <div
        id="onboardingjoin"
        className="absolute mx-auto p-3 lg:p-0 justify-center w-full  top-[6244px] md:top-[6250px] lg:top-[4207px] flex flex-col items-center gap-[32px] p-0"
      >
        <div className="flex flex-col items-center justify-center gap-3 w-full mx-auto h-[120px]">
          <div className="flex flex-col  sm:mx-auto items-start  justify-center w-full   p-2 ">
            ...
            {/* Form Section */}
            <div className="flex mx-auto   flex-col   items-start   mt-[10px] lg:mt-10 md:mt-10 p-4 lg:p-8 gap-6 w-full md:w-[600px] lg:w-[763px] lg:h-[500px]  bg-white border-l border-t border-b border-[#e5e5e5] shadow-lg rounded-r-lg">
              <form
