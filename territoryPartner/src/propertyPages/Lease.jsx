...
export default function Lease() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/lease", {
        method: "GET",
  ...
  const fetchAllCity = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/lease/allcity", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocation = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/lease/alllocation", {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchLocationByCity = async () => {
    try {
      const response = await fetch(URI + "/territory-partner/lease/location/" + city, {
        method: "GET",
        credentials: "include", // ✅ Ensures cookies are sent
        headers: {
          "Content-Type": "application/json",
  ...
  const addLike = async (id) => {
    try {
      const response = await fetch(URI + "/territory-partner/lease/like/" + id, {
        method: "PUT",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
