...
const OnBoardingPartner = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        `${URI}/promoter/partner/${partnerPaymentStatus}`,
        {
          method: "GET",
  ...
  const add = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`${URI}/promoter/partner/${endpoint}`, {
  ...
  const updatePaymentId = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(
        URI + `/admin/partner/update/paymentid/${partnerId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    ...
    >
      <div className="sales-table w-full h-[80vh] flex flex-col px-4 md:px-6 py-6 gap-4 my-[10px] bg-white md:rounded-[24px]">
        ...
        <h2 className="text-[16px] font-semibold">Onboarding Partner List</h2>
            ...
            <div className="grid gap-6 md:gap-4 grid-cols-1">
              ...
              <div className="w-full">
                ...
                >
                  ...
                  <option value="Strong Market Growth">
