...
const PriceSummery = () => {
  ...
  return (
    <div className="absolute bottom-0 sm:top-24 max-w-3xl overflow-scroll scrollbar-hide mx-auto h-[90vh] sm:h-[75vh] bg-white rounded-tl-2xl rounded-tr-2xl sm:rounded-xl shadow-xl p-6 space-y-4">
      {/* Header */}
